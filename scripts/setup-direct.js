...
// Remplacez YOUR_DB_PASSWORD par le mot de passe de la base
...
const client = new Client({
  host: process.env.SUPABASE_POOLER_HOST || 'aws-0-us-east-1.pooler.supabase.com',
...
async function setup() {
  ...
  try {
    ...
    const result = await client.query(`
      ...
      AND tablename IN ('profiles','properties','conversations','messages','notifications')
    `);
