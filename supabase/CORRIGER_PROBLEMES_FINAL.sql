-- NIUMBA - Corriger Tous les Problèmes (VERSION FINALE - Sans Erreur)
...
-- 2. Créer les policies manquantes pour profiles
DO $$ BEGIN
  IF NOT EXISTS (
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'properties' 
    AND policyname = 'properties_insert_authenticated'
  ) THEN
